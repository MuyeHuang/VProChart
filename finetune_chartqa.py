...
from transformers import DonutProcessor, BartConfig
import argparse
...
def main():
  ...
  parser.add_argument('--data-path', type=str, default = "your_org/your_dataset_name", help='Path to the data file')
  parser.add_argument('--train-images', type=str, default='/path/to/your/train/images/', help='Path to the training images')
  parser.add_argument('--valid-images', type=str, default='/path/to/your/val/images/', help='Path to the validation images')

  parser.add_argument('--output-dir', type=str, default="/path/to/your/output_data/", help='Path to the output directory for saving the checkpoints')
  ...
  parser.add_argument('--checkpoint-path', type=str, default = "/path/to/your/pretrained_model/", help='Path to the checkpoint')
  ...
  val_dataset = ChartQADataset(dataset["validation"], images_folder = args.valid_images, processor = processor, max_length=args.max_length,
