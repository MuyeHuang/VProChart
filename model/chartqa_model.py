...
class ChartQAModule(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        pixel_values, decoder_input_ids, labels, query_ids = batch
    ...
    def validation_step(self, batch, batch_idx, dataset_idx=0):
        pixel_values, decoder_input_ids, prompt_end_idxs, answers, query_ids = batch
    ...
    def val_dataloader(self):
        return DataLoader(self.val_dataset, batch_size=self.args.valid_batch_size, shuffle=True, num_workers=self.args.num_workers)
