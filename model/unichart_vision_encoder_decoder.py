...
from .swin.unichart_donut_swin import DonutSwinModel
from .improved_cluster_reasoning import HierarchicalClusteringLayer,ClusterAlignmentUnit
...
class VisionEncoderDecoderModel(PreTrainedModel):
    ...
    def __init__(
        ...
        self.cluster_layer = HierarchicalClusteringLayer(1024,5)
        self.cluster_align = ClusterAlignmentUnit()

        if encoder is None:
            encoder = DonutSwinModel(config.encoder,self.cluster_layer,self.cluster_align)
